<html>
    ...
    <body>
        <nav id="menuPaziente" class="side-menu hidden">
            <ul>
                <li class="menu-item"><a href="dashboard.php">Dashboard</a></li>
                <li class="menu-item"><a href="profilo.php">Profilo</a></li>
                ...
                <p class="section">PAGAMENTI</p>
                <li class="menu-item"><a href="pagamenti.php">Pagamenti e fatture</a></li>
            </ul>
        </nav>
    </body>
</html>